...
//echo(xorString(","mormon")."<br>");
$msg="Hello! My name is Elder Green!";
$ciphertext=Weakcrypt::encrypt($msg);
$plaintext=Weakcrypt::decrypt($ciphertext);
echo($ciphertext."<br>".$plaintext);
?>