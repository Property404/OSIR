...
if "%1" == "g++" (
	set c_compiler=g++ -s -Wall -Wextra -pedantic %2%
	set low_compiler=gcc
)
...
echo We dont need no education. We dont need no thought control. No dark sarcasm, in the classroom. Teacher leave us kids alone. Hey! Teacha! Leave them kids alone. All and all youre just another...brick in the wall > playground\dummy.txt
...
REM build tests
REM echo Building infection_system.c
